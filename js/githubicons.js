(function(){
  ...
  gitFork.setAttribute('src', 'http://ghbtns.com/github-btn.html?user=axiomzen&repo=flexgrid.css&type=fork&count=true');
  gitFork.setAttribute('allowtransparency', 'true');
  gitFork.setAttribute('frameborder', '0');
  gitFork.setAttribute('scrolling', '0');
  gitFork.style.display = 'inline-block';
  gitFork.style.width = '95px';
  gitFork.style.height = '20px';
  gitFork.style.margin = '0';
  gitFork.style.verticalAlign = 'middle';
  document.getElementById('github-icons').appendChild(gitFork);

  var gitWatch = document.createElement('iframe');
  gitWatch.setAttribute('src', 'http://ghbtns.com/github-btn.html?user=axiomzen&repo=flexgrid.css&type=watch&count=true');
  ...
  gitWatch.style.margin = '0';
  gitWatch.style.verticalAlign = 'middle';
